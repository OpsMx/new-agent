...
################################################################################
#KUBECTL="kubectl -n payu-agent --kubeconfig /home/srini/payu/config-payu"
#KUBECTL="kubectl -n agent-for-srini-new-agent"
KUBECTL="kubectl --kubeconfig /home/srini/srini-new-agent-setup/srini-new-agent/config.srini-new-agent -n local-agent"
SEDCHAR="?"
